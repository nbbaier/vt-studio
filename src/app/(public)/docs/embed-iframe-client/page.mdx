...
export const metadata = {
  title: "Embedding Outerbase Studio via iFrame",
};

<DocContent title="Embedding Our Client via iFrame" group="Integration">

Outerbase Studio is a powerful SQLite client that you can embed
...
- Instant access to Outerbase Studio updates

## Embed Outerbase Studio

You can embed Outerbase Studio as follows:
...
```html
<iframe
  src="https://libsqlstudio.com/embed/sqlite?name=MyCoolDatabase"
></iframe>
```

## Example

Here is a sample code demonstrating how to integrate using React:
