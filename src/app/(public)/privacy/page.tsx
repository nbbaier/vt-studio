  ...
  return (
    <WebsiteLayout>
      <div className="container mx-auto my-12 flex flex-col gap-4">
        <h1 className="text-3xl font-bold">PRIVACT NOTICE</h1>
        ...
        <h3 className="text-md font-bold">3.1 Service Providers</h3>
        <p>
        ...
        <h3 className="text-md font-bold">3.2 Legal Requirements</h3>
        <p>
